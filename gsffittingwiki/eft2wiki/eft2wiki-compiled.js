(function () {
    ...
    var EFT_SECTIONS = [['name', 'low', 'med', 'high', 'rig', 'sub'], ['drone'], ['implant'], ['cargo']];
    ...
    function startProcessEFT(event) {
        ...
        let inputs = Array.from(eftForm.querySelectorAll('textarea')).concat(Array.from(eftForm.querySelectorAll('input'))).concat(Array.from(eftForm.querySelectorAll('button')));
...
//# sourceMappingURL=eft2wiki-compiled.js.map